...
| F4 | quotactl / quotactl_fd (179/443) | WIP | B644 | ENOSYS. Implement quota ops. |
...
| G3 | getrusage/times (98/100) | WIP | B645 | report wall-clock for utime, zeroed counters. Track real per-task CPU time + rusage counters. |
