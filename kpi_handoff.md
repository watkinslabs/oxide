...
## Sysfs Emit Follow-Up

- Added Linux sysfs page-buffer formatter exports required by Fedora 6.16 `target_core_mod` and `libcomposite`: `sysfs_emit` and `sysfs_emit_at`.
