...
ACTIVE NOW: `B341-virtio-gpu-drm-real-parent` — CLAIMED.

Current active item: `>>> ACTIVE >>> B341-virtio-gpu-drm-real-parent`.

Current B341 gate: prove or fix virtio-gpu DRM card model devices using the
owning virtio child as parent, with hosted source proof and x86_64/aarch64
runtime discovery.
...
| CLAIMED | B341-virtio-gpu-drm-real-parent | Virtio-gpu registers DRM card devices with real virtio child parent. |
