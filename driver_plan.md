...
ACTIVE NOW: `B409-driver-model-setup-policy` — CLAIMED.
...
| >>> ACTIVE >>> CLAIMED | B409-driver-model-setup-policy | Driver model authoritative at Device/Driver level, but some setup policy remains in bus/transport helper code. Source audit, hosted tests, and x86_64/aarch64 runtime proof pending. |
