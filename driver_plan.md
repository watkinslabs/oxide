...
ACTIVE NOW: `B358-fbdev-flush-blank-record` — CLAIMED.

Current active item: `>>> ACTIVE >>> B358-fbdev-flush-blank-record`.

Current B358 gate: audit fbdev flush/blank routing and prove per-`/dev/fbN` record behavior.
...
| >>> ACTIVE >>> CLAIMED | B358-fbdev-flush-blank-record | fbdev flush/blank ops are per `/dev/fbN` record. |
