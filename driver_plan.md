...
ACTIVE NOW: `B365-fbdev-fbio-usercopy-bounds` — CLAIMED, source audit starting.

Current active item: `>>> ACTIVE >>> B365-fbdev-fbio-usercopy-bounds`.

Current B365 gate: source audit, focused hosted proof, x86_64/aarch64 driver-path proof.
...
| >>> ACTIVE >>> CLAIMED | B365-fbdev-fbio-usercopy-bounds | fbdev FBIO user-copy validation uses checked exclusive-end arithmetic; audit ioctl user buffer range checks, add focused proof if needed, then run hosted and x86_64/aarch64 driver-path gates. |
