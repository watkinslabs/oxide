...
Current B413 gate: prove hardware-backed devtmpfs publication is model-owned
and direct devfs users remain limited to fixed pseudo/non-hardware namespace
cases; then run hosted tests plus x86_64/aarch64 runtime proof.
