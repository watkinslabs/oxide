...
ACTIVE NOW: `B364-drm-map-dumb-cookie-validation` — CLAIMED, source audit starting.

Current active item: `>>> ACTIVE >>> B364-drm-map-dumb-cookie-validation`.

Current B364 gate: source audit, focused hosted proof, x86_64/aarch64 driver-path proof.
...
| >>> ACTIVE >>> CLAIMED | B364-drm-map-dumb-cookie-validation | MODE_MAP_DUMB cookies are high-tagged and validated; audit dumb-map offset encoding/decoding, add focused proof if needed, then run hosted and x86_64/aarch64 driver-path gates. |
