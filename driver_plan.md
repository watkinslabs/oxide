...
ACTIVE NOW: `B414-driver-devnode-readd-loops` — CLAIMED.
...
| >>> ACTIVE >>> CLAIMED | B414-driver-devnode-readd-loops | Driver-owned devnode remove/readd hosted loops cover block, evdev, fbdev, DRM, hwrng; broaden to all subsystem nodes. Source audit, hosted tests, and x86_64/aarch64 runtime proof pending. |
