...
ACTIVE NOW: B428-sysfs-explicit-bind-route; IN AUDIT.

Current active item: Explicit bind routing through sysfs driver `bind`.

Next gate after merge: return to fresh `origin/main` before claiming B429
...
| ACTIVE | B428-sysfs-explicit-bind-route | Route explicit binds through sysfs driver `bind` control path. |
