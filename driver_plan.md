...
ACTIVE NOW: `B380-virtio-net-ipv6-ndp-stack-owned` — VERIFIED, PR READY.

Current active item: `>>> ACTIVE >>> B380-virtio-net-ipv6-ndp-stack-owned`.

Current B380 gate: source, hosted NDP tests, virtio-net tests, line checks,
