...
ACTIVE NOW: `B353-drm-client-cap-rejects-unsupported` — IN AUDIT.

Current active item: `>>> ACTIVE >>> B353-drm-client-cap-rejects-unsupported`.

Current B353 gate: audit DRM SET_CLIENT_CAP supported-cap table, add hosted
regressions for unsupported atomic/writeback/aspect/stereo/cursor-hotspot caps,
then x86_64/aarch64 driver-path proof.
...
| >>> ACTIVE >>> IN AUDIT | B353-drm-client-cap-rejects-unsupported | DRM SET_CLIENT_CAP rejects unsupported atomic/writeback/aspect/stereo/cursor hotspot caps. |
