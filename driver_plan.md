...
ACTIVE NOW: `B342-parented-drm-minors-links` — CLAIMED.

Current active item: `>>> ACTIVE >>> B342-parented-drm-minors-links`.

Current B342 gate: prove or fix parented DRM minors under the owning device,
including class links and `/sys/dev/char` links, with hosted source proof and
x86_64/aarch64 runtime discovery.
...
| CLAIMED | B342-parented-drm-minors-links | Parented DRM minors live under owning device with class and `/sys/dev/char` links. |
