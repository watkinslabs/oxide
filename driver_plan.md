...
ACTIVE NOW: B427-no-public-auto-bind; IN AUDIT.

Current active item: Public `drv::auto_bind` removal and internal auto-attach proof.
...
| ACTIVE | B427-no-public-auto-bind | Remove public `drv::auto_bind`; keep automatic attachment internal to `try_device_add` and `register_driver`. |
