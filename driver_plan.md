...
ACTIVE NOW: `B405-pl011-receive-irq-owned` — CLAIMED.

Current active item: `>>> ACTIVE >>> B405-pl011-receive-irq-owned`.

Current B405 gate: audit/fix PL011 receive so input delivery is IRQ-owned
rather than timer-poll fallback; prove with hosted UART/serialtty tests and
...
| >>> ACTIVE >>> CLAIMED | B405-pl011-receive-irq-owned | PL011 receive path is IRQ-owned rather than timer-poll fallback. |
