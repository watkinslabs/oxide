...
ACTIVE NOW: B434-model-binding-bus-driver-match; IN AUDIT.

Current active item: Model binding verifies bus/driver matching.

Next gate after B434: prove source, hosted tests, decide whether runtime proof
is inherited or needs fresh x86_64/aarch64 smoke, PR merge, then fresh
`origin/main` before claiming B435.
...
| ACTIVE | B434-model-binding-bus-driver-match | Model binding verifies bus/driver matching. |
