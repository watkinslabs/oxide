...
ACTIVE NOW: B452-shutdown-all-reverse-registration; IN AUDIT.

Current active item: `drv::shutdown_all` walks bound model devices in reverse
registration order.

Next gate after B452: prove source traversal order, hosted driver-model
...
| ACTIVE | B452-shutdown-all-reverse-registration | `drv::shutdown_all` walks bound model devices in reverse registration order. |
