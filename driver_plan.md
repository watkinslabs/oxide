...
ACTIVE NOW: B437-probe-failure-unbound-retriable; IN AUDIT.

Current active item: Probe failure leaves device unbound and retriable.

Next gate after B437: prove source, hosted tests, decide whether runtime proof
is inherited or needs fresh x86_64/aarch64 smoke, PR merge, then fresh
`origin/main` before claiming B438.
...
| ACTIVE | B437-probe-failure-unbound-retriable | Probe failure leaves device unbound and retriable. |
