...
ACTIVE NOW: `B348-drm-master-open-file-state` — CLAIMED.

Current active item: `>>> ACTIVE >>> B348-drm-master-open-file-state`.

Current B348 gate: audit DRM master ownership against Linux open-file
description semantics; add focused proof, then prove x86_64 and aarch64 driver
path.
...
| CLAIMED | B348-drm-master-open-file-state | DRM master state is per open file description. |
