...
ACTIVE NOW: `B380-virtio-net-ipv6-ndp-stack-owned` — IN AUDIT.

Current active item: `>>> ACTIVE >>> B380-virtio-net-ipv6-ndp-stack-owned`.

Current B380 gate: prove virtio-net IPv6 NDP learning goes through the
stack-owned interface table, from current source plus hosted and
...
| >>> ACTIVE >>> IN AUDIT | B380-virtio-net-ipv6-ndp-stack-owned | IPv6 NDP learning goes through stack-owned interface table. |
