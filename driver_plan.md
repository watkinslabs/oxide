...
ACTIVE NOW: `B411-virtio-irq-core-bus-split` — CLAIMED.

Current active item: `>>> ACTIVE >>> B411-virtio-irq-core-bus-split`.

Current B411 gate: prove virtio IRQ callback ownership and the remaining
virtio-core/bus split state. Source audit, hosted tests, and x86_64/aarch64
...
| >>> ACTIVE >>> CLAIMED | B411-virtio-irq-core-bus-split | Virtio IRQ callback ownership improved, but true virtio-core/bus split remains incomplete. Source audit, hosted tests, and x86_64/aarch64 runtime proof pending. |
