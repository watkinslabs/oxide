...
ACTIVE NOW: `B411-virtio-irq-core-bus-split` — VERIFIED.

Current active item: `>>> ACTIVE >>> B411-virtio-irq-core-bus-split`.

Current B411 gate: virtio IRQ callback ownership and current core/bus split
state verified; remaining full extraction stays in later virtio split row.
