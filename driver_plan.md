...
ACTIVE NOW: `B369-virtio-net-rx-runtime-owner` — IN AUDIT.

Current active item: `>>> ACTIVE >>> B369-virtio-net-rx-runtime-owner`.

Current B369 gate: prove virtio-net owns RX runtime installation/removal by child key, add focused regression if missing, run virtio-net tests, x86_64/aarch64 driver-path proof, push PR, merge, then sync local `main`.
...
| >>> ACTIVE >>> IN AUDIT | B369-virtio-net-rx-runtime-owner | Virtio-net owns RX runtime installation/removal. |
