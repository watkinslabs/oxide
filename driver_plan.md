...
ACTIVE NOW: `B396-sound-ops-route-by-owner` — CLAIMED.

Current active item: `>>> ACTIVE >>> B396-sound-ops-route-by-owner`.

Current B396 gate: prove or fix sound ops dispatch so every PCM/capture/control
and OSS path routes by explicit owner, with hosted tests and x86_64/aarch64
...
| >>> ACTIVE >>> CLAIMED | B396-sound-ops-route-by-owner | Sound ops route by owner. |
