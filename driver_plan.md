...
ACTIVE NOW: B439-driver-unregistration-detaches-bound; IN AUDIT.

Current active item: Driver unregistration detaches devices bound to that driver before removing the driver from registry.

Next gate after B439: prove source, hosted tests, decide whether runtime proof
is inherited or needs fresh x86_64/aarch64 smoke, PR merge, then fresh
`origin/main` before claiming B440.
...
| ACTIVE | B439-driver-unregistration-detaches-bound | Driver unregistration detaches devices bound to that driver before removing the driver from registry. |
