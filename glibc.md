...
> `libc.so.6` (**~2121 exported**). Directive: implement EVERYTHING achievable
...
- **re_* BSD regex (~6)** — re_match_2/re_search_2/re_set_registers/
  re_set_syntax/re_syntax_options and legacy globals.
