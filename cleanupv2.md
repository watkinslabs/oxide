...
Open follow-ups: update-utmp-**runlevel** exit-1 deeper D-Bus `ActiveState` cause (needs debug-gated reply trace); hwdb.bin mmap-ENODATA (2.2); S1 device-node timing; S2/S3 net/UTS-ns; S4/S5 udev netns + sysctl leaves; S8 SCM_RIGHTS correct re-fix; S10 BPF-LSM.
