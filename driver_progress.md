...
| Branch | Status | Evidence |
|---|---|---|
| B437-probe-failure-unbound-retriable | IN AUDIT | Fresh main `e92b7401` after PR #2492 merge; auditing failed probe behavior and retriable explicit bind semantics. |
