...
Current marker: `>>> ACTIVE >>> B415-bind-unbind-readd-proof`.
...
| B415-bind-unbind-readd-proof | CLAIMED | Repeated bind/unbind/remove/readd proof claimed; source audit, hosted tests, and x86_64/aarch64 runtime proof pending. |
