...
| Branch | Status | Evidence |
|---|---|---|
| B439-driver-unregistration-detaches-bound | IN AUDIT | Fresh main `583c456b` after PR #2494 merge; auditing driver unregistration detach-before-registry-removal behavior. |
