...
| Branch | Status | Evidence |
|---|---|---|
| B443-platform-serial-model-attach | IN AUDIT | Fresh main `a6fc640d` after PR #2500 merge; auditing boot-time platform serial device publication and attachment through the model-owned driver path. |
