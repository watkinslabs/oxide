...
| B409-driver-model-setup-policy | CLAIMED | Driver-model authority/setup-policy audit claimed; source audit, hosted tests, and x86_64/aarch64 driver-path proof pending. |
