...
Current marker: `>>> ACTIVE >>> B413-devtmpfs-model-owned-publication`.
...
| B413-devtmpfs-model-owned-publication | CLAIMED | Devtmpfs model-owned hardware publication proof claimed; source audit, hosted tests, and x86_64/aarch64 driver-path proof pending. |
