...
| Branch | Status | Evidence |
|---|---|---|
| B434-model-binding-bus-driver-match | IN AUDIT | Fresh main `b8ccf81a` after PR #2489 merge; auditing driver-core bus scoping and driver match verification before marking the row verified. |
