...
| Branch | Status | Evidence |
|---|---|---|
| B433-model-binding-rejects-bound-devices | IN AUDIT | Fresh main `114fdf3d` after PR #2488 merge; auditing the driver-core already-bound rejection path before marking the row verified. |
