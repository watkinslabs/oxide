...
Current marker: `>>> ACTIVE >>> B396-sound-ops-route-by-owner`.
...
| B396-sound-ops-route-by-owner | ACTIVE | Claimed from fresh main; prove PCM/capture/control/OSS dispatch selects explicit owner only. |
