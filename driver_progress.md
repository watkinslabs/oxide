...
Current marker: `>>> ACTIVE >>> B416-nvme-ahci-multicontroller-proof`.
...
| B416-nvme-ahci-multicontroller-proof | CLAIMED | NVMe/AHCI multi-controller QEMU bind/unbind/rebind proof claimed; source audit, hosted tests, and x86_64/aarch64 runtime proof pending. |
