...
| Branch | Status | Evidence |
|---|---|---|
| B444-i8042-platform-model-attach | IN AUDIT | Fresh main `6fe6f3f6` after PR #2501 merge; auditing x86_64 boot-time i8042 platform device publication and attachment through the model-owned driver path. |
