...
Current marker: `>>> ACTIVE >>> B414-driver-devnode-readd-loops`.
...
| B414-driver-devnode-readd-loops | CLAIMED | Devnode remove/readd loop broadening claimed; source audit, hosted tests, and x86_64/aarch64 driver-path proof pending. |
