...
| CLAIMED B1516-ahci-hba-reset | B1516-ahci-hba-reset | AHCI never resets the HBA | `drv-ahci/src/regs.rs:18` | `bring_up` sets only `GHC.AE`; Linux `ahci_reset_controller` drives `GHC.HR` first. Firmware-left state survives into our driver. |
