...
| CLAIMED B1513-bridge-arp-validation | B1513-bridge-arp-validation | Bridge never answers ARP for its own IPv4 | `net/src/stack/bridge_tx.rs:44` | `bridge_answer_arp` is a complete responder with zero callers. A `br0` holding an address is unreachable from the LAN. Bridge RX should call it before FDB forwarding. |
