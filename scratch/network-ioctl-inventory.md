...
| `SIOCDARP` (0x8953), `SIOCGARP` (0x8954), `SIOCSARP` (0x8955) | ARP / neighbour | Missing ABI route; canonical per-interface IPv4 neighbour owner exists | `stack/arp_neighbor.rs`, `stack/ethernet.rs`, virtio neighbour path | neighbour lookup/mutation, capability, address family, namespace, error order |
