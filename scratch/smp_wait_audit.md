...
| Prepared resource wait | hold resource gate, enqueue, recheck, unlock, sleep, finish | Pipe ring, eventfd, timerfd, POSIX MQ, and the VSOCK send/receive/connect/accept family now use the named prepared API. Remaining socket families, tty, rwsems and comparable lock-coupled callers remain to rename and validate individually. |
