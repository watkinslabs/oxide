...
| E4-05 | high | Retained pending checkpoint images, coalescing, journal-space accounting, and clean-publication state are implemented. The harness now covers power loss before publish, after publish, after home checkpoint, and during a partial home checkpoint; descriptor/data/commit-specific crash points and broader write-amplification evidence remain. | E4-01, E4-02 | crash/replay matrix, checkpoint-list tests, repeated boot/perf evidence |
...
| E4-07 | medium | Exact physical preallocation ownership, failed-claim rollback, contiguous locality-tail consumption, and Linux's `fls(len)-2` average-fragment buckets are covered. Multiblock allocation still differs in the remaining scan heuristics and complete locality preallocation lifecycle. | E4-01, E4-02, E4-05 | allocator model tests, fragmentation/failure tests, e2fsck-clean images, measured workload |
