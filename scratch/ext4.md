...
|---|---|---|---|---|
| E4-01 | high | Owned concurrent block reads are now the ordinary ext4 file-read path; the remaining gap is the broader image/boot exit matrix. | E4-02 | concurrent read stress, byte-for-byte image validation, no boot regression, both arches |
