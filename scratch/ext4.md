...
| E4-05 | high | Retained pending checkpoint images, coalescing, journal-space accounting, and clean-publication state are implemented. The harness now covers power loss after home checkpoint and before clean publication; the broader crash/replay and write-amplification evidence remains. | E4-01, E4-02 | crash/replay matrix, checkpoint-list tests, repeated boot/perf evidence |
