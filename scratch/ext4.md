...
| E4-07 | medium | Exact physical preallocation ownership is fixed, but multiblock allocation still differs from Linux in scan heuristics and the complete locality preallocation lifecycle. | E4-01, E4-02, E4-05 | allocator model tests, fragmentation/failure tests, e2fsck-clean images, measured workload |
