...
| E4-04 | high | Journal replay stale-cache `EIO` is fixed and quota replay coverage is present; GNOME dconf write allocation/writeback/persistence evidence remains. | E4-02, E4-05 | focused write/persistence test, remount persistence, live GNOME dconf write |
