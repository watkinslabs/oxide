...
| E4-09 | medium | `inode_readahead_blks` now warms a bounded inode-table window through the canonical metadata cache; async completion ownership and performance comparison remain with E4-01/E4-02/E4-15. | E4-01, E4-02 | cold-lookup/image coverage, async ownership integration, boot/perf comparison |
