...
| N21 teardown | `IN-PROGRESS` `[CLAIMED B1285-raw6-namespace-teardown 2026-07-20]` | transport/raw/packet close, poll wakeups, fragment/NDP isolation | every family across move/remove/final-drop, blocked I/O, real poll/epoll, multicast/routes/neighbors/diagnostics, runtime differential | prove Raw6 namespace teardown closes the endpoint and publishes terminal poll state |
