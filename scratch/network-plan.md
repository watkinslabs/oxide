...
| N20 TCP edges | `IN-PROGRESS` `[CLAIMED B1284-tcp-established-fixture 2026-07-20]` | hosted OOB, backlog, reuseport, retransmit, RST, TIME_WAIT, keepalive work; D353 Linux-owner inventory | remaining SYN/cookie, accept/reuseport, urgent, async-error, PMTU and runtime matrices | retain a bidirectional TCP TX → loopback RX → TCP demux fixture, then add target urgent/`TCP_INFO` frames |
