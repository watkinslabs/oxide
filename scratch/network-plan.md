...
| N21 teardown | `IN-PROGRESS` (`B1269-network-teardown-audit`) | transport/raw/packet close, poll wakeups, fragment/NDP isolation; B1269 AF_UNIX peer-close epoll/EOF host contract and ARM oxide-loader artifact | every family across move/remove/final-drop, blocked I/O, real poll/epoll, multicast/routes/neighbors/diagnostics, runtime differential | audit Linux close ownership and isolate the first missing contract |
