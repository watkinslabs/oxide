...
| N20 TCP edges | `IN-PROGRESS` | hosted OOB, backlog, reuseport, retransmit, RST, TIME_WAIT, keepalive work; D353 Linux-owner inventory; F699 loopback ACK/output ordering fixture (2 cases; hosted net 910/910) | remaining SYN/cookie, accept/reuseport, urgent, async-error, PMTU and runtime matrices | retain Linux-oracle target urgent/`TCP_INFO` frames, then add loss/reorder fixture before state-machine changes |
