...
| Status | Branch | Item |
|---|---|---|
| FIXED | B3630-paint-region-collapse | KI0925 menu OCR |
...
Actual source before correction:1failed/1passed, /tmp/B3630-menu-ocr-red.log. Corrected:2passed, /tmp/B3630-menu-ocr-green.log. Erasing the actual menu must still return None. Fixture is the unmodified Notepad window crop from diagnostic4127818. Adjacent menu/frame/document/launch tests:19passed, /tmp/B3630-menu-ocr-tests.log. Live4192767 passes initial-token and clicks File/Open through actual menu lookup. Open then fails actual decoration observation, independently of repaired menu OCR.
