...
void bio_init(struct bio *bio, struct block_device *bdev, void *table, unsigned int nr_vecs, u32 opf);
...
int __bio_add_page(struct bio *bio, struct page *page, unsigned int len, unsigned int off);
