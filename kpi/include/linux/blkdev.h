...
struct queue_limits {
    ...
    u32 chunk_sectors;
    u32 max_sectors;
    u32 max_user_sectors;
    u32 max_segment_size;
    u32 max_fast_segment_size;
    ...
    u32 max_hw_discard_sectors;
    u32 max_user_discard_sectors;
    u32 max_secure_erase_sectors;
    u32 max_write_zeroes_sectors;
    u32 max_wzeroes_unmap_sectors;
    u32 max_hw_wzeroes_unmap_sectors;
    u32 max_user_wzeroes_unmap_sectors;
    u32 max_hw_zone_append_sectors;
    u32 max_zone_append_sectors;
    u32 discard_granularity;
    u32 discard_alignment;
    u32 zone_write_granularity;
    u32 atomic_write_hw_max;
    u32 atomic_write_max_sectors;
    u32 atomic_write_hw_boundary;
    u32 atomic_write_boundary_sectors;
    u32 atomic_write_hw_unit_min;
    u32 atomic_write_unit_min;
    u32 atomic_write_hw_unit_max;
    u32 atomic_write_unit_max;
    u16 max_segments;
    u16 max_integrity_segments;
    u16 max_discard_segments;
    u16 max_write_streams;
    u32 write_stream_granularity;
    u32 max_open_zones;
    u32 max_active_zones;
    u32 dma_alignment;
    u32 dma_pad_mask;
    struct blk_integrity { u8 flags; u8 csum_type; u8 metadata_size; u8 pi_offset;
        u8 interval_exp; u8 tag_size; u8 pi_tuple_size; } integrity;
};

_Static_assert(sizeof(struct queue_limits) == 192, "queue_limits ABI size");
_Static_assert(__builtin_offsetof(struct queue_limits, logical_block_size) == 56, "queue_limits logical block offset");
_Static_assert(__builtin_offsetof(struct queue_limits, integrity) == 184, "queue_limits integrity offset");
