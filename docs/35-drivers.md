...
- `drv-simplefb` (early firmware linear-framebuffer console; native display revokes the overlapping aperture or removes the temporary owner before takeover while retaining the VT renderer)
