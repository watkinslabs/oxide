...
- `ProcessBasicInformation`, `ProcessAffinityMask`, `ProcessWow64Information`, `ProcessImageFileName`, `ProcessImageFileNameWin32`, and `ProcessHandleCount` are implemented; other classes remain explicitly unsupported.
