...
`F638-glibc-syscall-locale-search-internal-aliases`. `glibc.md` = live per-cluster TODO. F counter next = **639**, B = **138**, D = **113**
(metadata/index.md).
...
- **F632 DONE locally:** legacy ctype data compatibility exports added for
  ...
  builds.
- **F633 DONE locally:** internal global data aliases added for `__environ`,
  `__progname`, `__progname_full`, `__daylight`, `__timezone`, and `__tzname`,
...
- **F635 DONE locally:** parser/time/ctype internal aliases added for
  `__getmntent_r`, `__gmtime_r`, `__isctype`, `__inet_aton_exact`, and
