...
- `be75cfdb2` commits the ZRAM/swap/MM/block buildout; `feb058036` ignores local boot artifacts; `88cee21fe` resolves `backing_dev` in the writer's real VFS context and preserves `ENOTBLK`; `15f205eba` rolls back stale swapin memcg charges.
