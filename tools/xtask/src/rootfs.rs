...
pub(crate) fn cmd_rootfs(rest: &[String]) -> Result<(), u8> {
    ...
    for b in &[
        ...
        "cgroup_smoke", "cmdsubst_probe", "alarm_probe", "quota_probe", "tcflow_probe", "tty_ioctl_probe", "io_uring_probe", "io_uring_reg_probe", "aio_probe", "tkill_probe", "pid_identity_probe", "sigframe_self_probe", "sigchld_probe", "symlink_probe",
