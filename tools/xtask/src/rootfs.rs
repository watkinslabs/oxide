...
pub(crate) fn cmd_rootfs(rest: &[String]) -> Result<(), u8> {
    ...
    for b in &[
        ...
        "uevent_probe", "rtlink_probe", "nlmcast_probe", "tracemark_probe", "tracepipe_probe", "tracesched_probe", "tracesys_probe", "fanotify_probe", "fanotify_perm_probe", "dev_smoke", "vim_smoke",
