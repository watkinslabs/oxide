...
pub(crate) fn cmd_rootfs(rest: &[String]) -> Result<(), u8> {
    ...
    for b in &[
        ...
        "socketpair_fork_probe", "tty_reset_probe", "dsr_probe", "vtswitch_probe", "vtmode_probe", "vtresize_probe", "kdfont_probe", "fbdev_probe", "fbdev_probe2", "vcs_probe", "ptyhup_probe", "hwrng_probe", "virtio_rng_rebind_probe", "virtio_parent_child_rebind_probe", "virtio_input_rebind_probe", "netstats_probe", "vsock_probe", "drm_probe", "drm_probe2", "drm_probe3", "sysblock_probe", "snd_probe", "mouseprobe",
