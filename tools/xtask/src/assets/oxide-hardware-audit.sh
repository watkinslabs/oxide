        ...
        case "$class" in
            ...
            0x020000*)
                case "$vendor:$product" in
                    ...
                    # These exact e1000e profiles have separate reset, NVM,
                    # and PHY implementations in the native driver.
                    0x8086:0x10d3|0x8086:0x10f6|0x8086:0x150c|0x8086:0x10ea|0x8086:0x10eb|0x8086:0x10ef|0x8086:0x10f0|0x8086:0x1502|0x8086:0x1503|0x8086:0x153a|0x8086:0x153b)
                        audit_pci_driver "$bdf" "$driver" e1000e ;;
                    # Linux e1000e: PCH/ICH integrated NICs require its
                    # MAC/PHY initialization rather than legacy e1000 reset.
                    # The supported PCH profiles above are deliberately
                    # excluded from this still-unimplemented remainder.
