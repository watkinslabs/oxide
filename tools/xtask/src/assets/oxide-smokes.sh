...
for s in /bin/bare3 /bin/vim_smoke /bin/sem_smoke /bin/msg_smoke /bin/mq_smoke \
         ...
         /bin/cmdsubst_probe /bin/alarm_probe /bin/symlink_probe /bin/mount_smoke /bin/statfs_smoke /bin/dev_smoke /bin/dsr_probe /bin/vtswitch_probe /bin/vtmode_probe /bin/vtresize_probe /bin/kdfont_probe /bin/fbdev_probe /bin/drm_probe /bin/vcs_probe /bin/ptyhup_probe /bin/hwrng_probe \
