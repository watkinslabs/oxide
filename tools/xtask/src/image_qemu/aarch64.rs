...
pub(super) fn qemu_run_aarch64_grub(
    ...
    c.args([
        ...
        // B1646: virtio-tablet (absolute pointer) → /dev/input/event2, lockstep
        // with x86. Declared AFTER the relative mouse so event0/event1 keep
        // their keyboard/mouse identities.
