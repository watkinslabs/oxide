...
enum { SAMPLE_MSC_CODE = 0 };
enum { SAMPLE_SND_CODE = 0 };
enum { SAMPLE_FF_CODE = 0 };
enum { SAMPLE_SW_CODE = 0 };
enum { SAMPLE_INPUT_DEV_ABI_SIZE = 2192 };
enum { SAMPLE_INPUT_PROPBIT_OFFSET = 344 };
enum { SAMPLE_INPUT_MSCBIT_OFFSET = 472 };
enum { SAMPLE_INPUT_SNDBIT_OFFSET = 488 };
enum { SAMPLE_INPUT_FFBIT_OFFSET = 496 };
enum { SAMPLE_INPUT_SWBIT_OFFSET = 512 };
enum { SAMPLE_INPUT_ABSINFO_OFFSET = 520 };
enum { SAMPLE_INPUT_SND_STATE_OFFSET = 2160 };
enum { SAMPLE_INPUT_SW_STATE_OFFSET = 2168 };
...
static int __init sample_init(void)
{
    ...
    if (input != NULL) {
        ...
        input_set_capability(input, EV_MSC, SAMPLE_MSC_CODE);
        input_set_capability(input, EV_LED, LED_NUML);
        input_set_capability(input, EV_SND, SAMPLE_SND_CODE);
        input_set_capability(input, EV_FF, SAMPLE_FF_CODE);
        input_set_capability(input, EV_SW, SAMPLE_SW_CODE);
        ...
        (void)test_bit(SAMPLE_MSC_CODE, input->mscbit);
        (void)test_bit(SAMPLE_SND_CODE, input->sndbit);
        (void)test_bit(SAMPLE_FF_CODE, input->ffbit);
        (void)test_bit(SAMPLE_SW_CODE, input->swbit);
...
_Static_assert(sizeof(struct input_dev) == SAMPLE_INPUT_DEV_ABI_SIZE, "input_dev ABI size");
_Static_assert(__builtin_offsetof(struct input_dev, propbit) == SAMPLE_INPUT_PROPBIT_OFFSET, "input_dev propbit offset");
_Static_assert(__builtin_offsetof(struct input_dev, mscbit) == SAMPLE_INPUT_MSCBIT_OFFSET, "input_dev mscbit offset");
_Static_assert(__builtin_offsetof(struct input_dev, sndbit) == SAMPLE_INPUT_SNDBIT_OFFSET, "input_dev sndbit offset");
_Static_assert(__builtin_offsetof(struct input_dev, ffbit) == SAMPLE_INPUT_FFBIT_OFFSET, "input_dev ffbit offset");
_Static_assert(__builtin_offsetof(struct input_dev, swbit) == SAMPLE_INPUT_SWBIT_OFFSET, "input_dev swbit offset");
_Static_assert(__builtin_offsetof(struct input_dev, absinfo) == SAMPLE_INPUT_ABSINFO_OFFSET, "input_dev absinfo offset");
_Static_assert(__builtin_offsetof(struct input_dev, snd) == SAMPLE_INPUT_SND_STATE_OFFSET, "input_dev snd state offset");
_Static_assert(__builtin_offsetof(struct input_dev, sw) == SAMPLE_INPUT_SW_STATE_OFFSET, "input_dev sw state offset");
