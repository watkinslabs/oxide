...
pub(crate) use publication::register_with_render;
...
pub use scanout::{clear_scanout_ops, present_primary_surface, scanout_ops,
                  set_primary_surface_presenter, set_scanout_ops, DamageRect,
                  ScanoutDriverKey, ScanoutOps, SurfacePresenter};
...
use crate::{
    ...
    DRM_IOCTL_VIRTGPU_RESOURCE_CREATE, DRM_IOCTL_VIRTGPU_RESOURCE_INFO,
