...
impl CommandTransport {
    ...
    pub fn new(page: DmaPage) -> Option<Self> { Some(Self { ring: CommandRing::new(page.pa())?, page }) }
    ...
    pub fn submit(&mut self, mmio: &Mmio, trb: Trb) -> Option<u64> {
        ...
        let index = pa.checked_sub(self.page.pa())?.checked_div(TRB_BYTES as u64)? as usize;
