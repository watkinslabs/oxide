...
// `register_driver` and `device_add` attachment.
...
pub mod model;
pub use model::{
    bind, BindEvent, Device, Driver, NodeFactory, Resource, register_driver, devices, device_count,
    device_add, try_device_add, device_del, driver_names, driver_names_for_bus, driver_count, match_driver, bind_addr, unbind,
