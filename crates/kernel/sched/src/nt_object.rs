...
mod namespace;
pub use namespace::{create_event, create_semaphore, directory_entries, directory_path, lookup_directory, lookup_object, publish_mutant, publish_section, publish_timer, NamedObjectState};
