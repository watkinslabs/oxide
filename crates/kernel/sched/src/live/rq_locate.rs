...
impl SchedChange<'_> {
    ...
    pub(crate) fn from_lock_mode<'a>(mut lock: TaskRqGuard<'a>, task: &'a Arc<Task>,
        ...
        SchedChange {
            ...
            old_deadline: task.effective_dl_deadline(), activate_parked_dl,
...
fn queue_key_changed(old: crate::SchedClass, old_deadline: u64,
                     new: crate::SchedClass, new_deadline: u64) -> bool {
    match (old, new) {
        (crate::SchedClass::Rt { prio: a, .. }, crate::SchedClass::Rt { prio: b, .. }) => a != b,
        (crate::SchedClass::Normal { weight: a }, crate::SchedClass::Normal { weight: b }) => a != b,
