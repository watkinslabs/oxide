...
fn snapshot_task(task: &Task) -> PidInfo {
    ...
    PidInfo {
        ...
        ruid: task.security.creds.ruid.load(Ordering::Acquire),
        rgid: task.security.creds.rgid.load(Ordering::Acquire),
        euid: task.security.creds.euid.load(Ordering::Acquire),
        egid: task.security.creds.egid.load(Ordering::Acquire),
        suid: task.security.creds.suid.load(Ordering::Acquire),
        sgid: task.security.creds.sgid.load(Ordering::Acquire),
        fsuid: task.security.creds.fsuid.load(Ordering::Acquire),
        fsgid: task.security.creds.fsgid.load(Ordering::Acquire),
