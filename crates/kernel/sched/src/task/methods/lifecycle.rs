    ...
    fn new_with_mm(
        ...
        Self {
            core: TaskCore {
                ...
                nt_creation_pending: AtomicBool::new(false),
                nt_native_thread: Spinlock::new(crate::nt_native_thread::State::new()),
                nt_start_address: AtomicU64::new(0),
                nt_thread_ui_languages: Spinlock::new((0, alloc::vec::Vec::new())),
                nt_desktop: Spinlock::new(crate::nt_object::ThreadDesktop::default()),
