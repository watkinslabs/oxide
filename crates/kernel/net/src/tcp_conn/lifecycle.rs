...
impl TcpConn {
    ...
    pub fn new_client(local: crate::tcp_conn::Endpoint, remote: crate::tcp_conn::Endpoint, isn: u32) -> Self {
        Self {
            ...
            fastopen_opt: None,
            syn_fastopen: false, syn_fastopen_exp: false,
            syn_data: false, syn_data_acked: false,
            fastopen_confirming: false, fastopen_learned: None, data_segs_in: 0,
            fastopen_client_fail: crate::tcp_fastopen::TFO_STATUS_NONE,
            fastopen_blackhole_seen: false,
            fastopen_child: false,
            rcv_buf_cap: 65_536,
            ...
            last_ack_recv_ns: 0,
            next_ka_ns:  0,
            syn_retries: crate::tcp_conn::SYN_RETRIES_DEFAULT,
            linger2_ns:  crate::tcp_conn::LINGER2_DEFAULT_NS,
            thin_lto:    false,
            user_timeout_ns: 0,
            first_unacked_ns: 0,
            repair:      false,
            ...
            tx_delay_ns: 0,
            rto_max_ns:  crate::tcp_conn::RTO_MAX_DEFAULT_NS,
            delack_max_ns: crate::tcp_conn::DELACK_MAX_DEFAULT_NS,
            delack_ato_ns: 0,
            snd_wl1:     0,
            max_window:  0,
            rcv_wnd:     0,
