...
// The neighbour state machine is family-generic and lives in `neigh`; this
// module owns only the IPv4 wire format and the names its callers already use.
pub use crate::neigh::{NeighAddr, NudState};
