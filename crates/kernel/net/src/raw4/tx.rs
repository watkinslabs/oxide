...
impl NetStack {
    ...
    pub fn send_raw4(&self, endpoint: &Raw4Endpoint, dst: Ipv4Addr,
        ...
        self.send_raw4_payload(endpoint, iface_id, iface, next_hop, source, route_dst, dst,
            endpoint.protocol(),
    ...
    fn send_raw4_payload(&self, endpoint: &Raw4Endpoint, iface_id: NetIfaceId,
        ...
        let full = raw4_packet(net_ns, src, wire_dst, final_dst, protocol, payload,
