...
#[cfg(test)]
#[path = "vsock_socket/tests/socket.rs"]
mod tests;

#[cfg(test)]
#[path = "vsock_socket/tests/linux.rs"]
mod linux_tests;

#[cfg(test)]
#[path = "vsock_socket/tests/interleaving.rs"]
mod interleaving_tests;

#[cfg(test)]
#[path = "vsock_socket/tests/lifecycle.rs"]
mod lifecycle_tests;

#[cfg(test)]
#[path = "vsock_socket/tests/listen.rs"]
mod listen_tests;
