...
impl TcpListenEntry {
    ...
    pub fn new_with_fastopen_frag(bind: Arc<TcpBindReservation>,
                           ...
                           min_hop: Arc<crate::min_hop::MinHop>,
                           fastopen: Arc<crate::tcp_fastopen::FastOpenQueue>) -> Self {
        Self::new_with_fastopen_frag_pacing(bind, bpf_filter, ip_mtu_discover,
            ipv6_mtu_discover, ipv6_frag_size, min_hop, fastopen,
            Arc::new(::core::sync::atomic::AtomicU64::new(u64::MAX)))
    }

    /// Build a listener sharing its IPv6 fragmentation and pacing requests. # C: O(1)
    #[allow(clippy::too_many_arguments)]
    pub fn new_with_fastopen_frag_pacing(bind: Arc<TcpBindReservation>,
                           bpf_filter: Arc<crate::bpf_filter::SocketFilter>,
                           ip_mtu_discover: Arc<::core::sync::atomic::AtomicI32>,
                           ipv6_mtu_discover: Arc<::core::sync::atomic::AtomicI32>,
                           ipv6_frag_size: Arc<::core::sync::atomic::AtomicI32>,
