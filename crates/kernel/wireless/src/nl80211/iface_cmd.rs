...
/// Not served yet. # C: O(1)
pub fn new(hdr: &Nlmsghdr, _attrs: &[u8], _ctx: GenlCtx) -> Vec<u8> {
    msg::error(hdr, Errno::Eopnotsupp)
}
...
/// Not served yet. # C: O(1)
pub fn del(hdr: &Nlmsghdr, _attrs: &[u8], _ctx: GenlCtx) -> Vec<u8> {
    msg::error(hdr, Errno::Eopnotsupp)
}

/// Not served yet. # C: O(1)
pub fn set_power_save(hdr: &Nlmsghdr, _attrs: &[u8], _ctx: GenlCtx) -> Vec<u8> {
    msg::error(hdr, Errno::Eopnotsupp)
}

/// Not served yet. # C: O(1)
pub fn get_power_save(hdr: &Nlmsghdr, _attrs: &[u8], _ctx: GenlCtx) -> Vec<u8> {
    msg::error(hdr, Errno::Eopnotsupp)
}

/// Not served yet. # C: O(1)
pub fn set_channel(hdr: &Nlmsghdr, _attrs: &[u8], _ctx: GenlCtx) -> Vec<u8> {
    msg::error(hdr, Errno::Eopnotsupp)
}

/// Not served yet. # C: O(1)
pub fn set_cqm(hdr: &Nlmsghdr, _attrs: &[u8], _ctx: GenlCtx) -> Vec<u8> {
    msg::error(hdr, Errno::Eopnotsupp)
}
