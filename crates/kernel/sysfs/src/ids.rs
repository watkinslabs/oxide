...
pub(crate) const HWMON_CLASS: u64 = 0x510B_4001;
pub(crate) const HWMON_VIRT: u64 = 0x510B_4002;
pub(crate) const HWMON_DIR: u64 = 0x510B_4100;
pub(crate) const HWMON_ATTR: u64 = 0x510B_4200;
pub(crate) const HWMON_LINK: u64 = 0x510B_4300;
