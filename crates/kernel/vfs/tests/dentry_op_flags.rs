...
static OPS_CMP: DentryOps = DentryOps { d_hash: None, d_compare: Some(CMP_FN), d_revalidate: None, d_delete: None, d_release: None, d_iput: None, d_dname: None };
static OPS_CI: DentryOps = DentryOps { d_hash: None, d_compare: Some(CMP_CI_FN), d_revalidate: None, d_delete: None, d_release: None, d_iput: None, d_dname: None };
static OPS_ALL4: DentryOps = DentryOps { d_hash: Some(HASH_FN), d_compare: Some(CMP_FN), d_revalidate: Some(REV_FN), d_delete: Some(DEL_FN), d_release: None, d_iput: None, d_dname: None };
