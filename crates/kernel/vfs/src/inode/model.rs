...
use core::any::Any;
use core::sync::atomic::{AtomicI32, AtomicI64, AtomicU16, AtomicU32, AtomicU64, Ordering};
...
pub struct Inode {
    ...
    /// Security class selected with `i_security`; zero derives it from mode.
    pub(super) i_security_class: AtomicU16,
