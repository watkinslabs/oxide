...
pub use devnode::{BlockDevOps, CharDevOps, Devt, DeviceNodeData, init_special_inode, make_device_node_inode, make_fifo_inode, make_socket_inode, device_inode_open, device_inode_ioctl, device_inode_devt, opened_chrdev, opened_device_devt, lookup_blkdev, lookup_chrdev, register_blkdev, register_blkdev_region, register_chrdev, register_chrdev_region, unregister_blkdev, unregister_blkdev_region, unregister_chrdev, unregister_chrdev_region, mkdev, kdev_major, kdev_minor, new_encode_dev, new_decode_dev, huge_encode_dev, MINORBITS, MINORMASK};
