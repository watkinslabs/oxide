...
impl Mount {
    ...
    /// Convert one in-memory PA reservation into a durable bitmap allocation.
    /// This is the Linux equivalent of consuming a block from an inode PA.
    pub(crate) fn claim_inode_prealloc_block(&self, phys: u64) -> Result<(), MountError> {
