...
pub(super) use runtime::{
    config_read, config_write, discard_saved_config, irq_vector, irq_vectors,
    load_saved_config, set_irq_vector_list, set_irq_vectors, set_wake_enabled,
    take_irq_vector_list,
};
#[cfg(test)]
pub(super) use runtime::{test_state_saved, test_wake_enabled};
