...
#[repr(C)]
pub struct LinuxIovIter {
    pub iter_type: u8,
    pub nofault: u8,
    pub data_source: u8,
    _pad: [u8; 5],
    pub iov_offset: usize,
    pub iov: *const LinuxIovec,
    pub count: usize,
    pub nr_segs: usize,
}

#[repr(C)]
pub struct LinuxIovec { pub base: *mut c_void, pub len: usize }
...
pub type ImportFixed = unsafe extern "C" fn(u64, usize, i32, *mut LinuxIovIter, *mut LinuxIoUringCmd, u32) -> i32;
pub type ImportFixedVec = unsafe extern "C" fn(*mut LinuxIoUringCmd, *const LinuxIovec, usize, i32, *mut LinuxIovIter, u32) -> i32;
...
unsafe extern "C" fn io_uring_cmd_import_fixed(buf: u64, len: usize, rw: i32, iter: *mut LinuxIovIter, cmd: *mut LinuxIoUringCmd, flags: u32) -> i32 {
...
unsafe extern "C" fn io_uring_cmd_import_fixed_vec(cmd: *mut LinuxIoUringCmd, vec: *const LinuxIovec, nr: usize, dir: i32, iter: *mut LinuxIovIter, flags: u32) -> i32 {
...
mod tests {
    ...
    unsafe extern "C" fn fixed(_buf: u64, _len: usize, _rw: i32, _iter: *mut LinuxIovIter, _cmd: *mut LinuxIoUringCmd, _flags: u32) -> i32 { 17 }
    unsafe extern "C" fn fixed_vec(_cmd: *mut LinuxIoUringCmd, _vec: *const LinuxIovec, _nr: usize, _dir: i32, _iter: *mut LinuxIovIter, _flags: u32) -> i32 { 19 }
    #[test] fn target_layouts_are_pinned() { assert_eq!(core::mem::size_of::<LinuxIoUringCmd>(), 64); assert_eq!(core::mem::offset_of!(LinuxIoUringCmd, pdu), 24); assert_eq!(core::mem::size_of::<LinuxIovIter>(), 40); assert_eq!(core::mem::size_of::<LinuxIovec>(), 16); }
