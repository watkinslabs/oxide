...
mod tests {
    ...
    // SAFETY: cmd is a fully initialized LinuxIoUringCmd local to this test, and install_cmd_hooks (called first on this line) installed task/done/fixed/fixed_vec as the exact ABI these transmute-based dispatchers expect.
