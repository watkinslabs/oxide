...
pub use registry::{Disk, Partition, ScsiDiskName, register, unregister, by_name, by_index, partition_by_label, partition_by_name, partition_by_uuid, rescan_partitions, reserve_scsi_disk_name, snapshot};
