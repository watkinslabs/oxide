...
use alloc::vec::Vec;
use super::bar_hit::bar_hit_test;
use super::popup::{hit_test, PopupHit, PopupLayout, NO_SELECTED_ITEM};
use super::track::MF_MOUSESELECT;
use super::{MenuId, MenuManager, MenuMetrics, MenuRect, MF_BYPOSITION};
...
/// and drawn with.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct BarChain { pub menu: u32, pub bounds: MenuRect, pub metrics: MenuMetrics }
