...
pub(crate) const VFAT_IOCTL_READDIR_BOTH: u64 = 0x8230_7201;
pub(crate) const VFAT_IOCTL_READDIR_SHORT: u64 = 0x8230_7202;
pub(crate) const FAT_IOCTL_GET_ATTRIBUTES: u64 = 0x8004_7210;
pub(crate) const FAT_IOCTL_SET_ATTRIBUTES: u64 = 0x4004_7211;
