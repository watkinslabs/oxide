...
/// `VALID_RESOLVE_FLAGS` (`fs/open.c`).
pub const RESOLVE_VALID: u64 = RESOLVE_NO_XDEV | RESOLVE_NO_MAGICLINKS | RESOLVE_NO_SYMLINKS
    | RESOLVE_BENEATH | RESOLVE_IN_ROOT | RESOLVE_CACHED;

/// `build_open_flags` (`fs/open.c`) resolve-word admission: unknown bits are
...
/// ladder at the tail of `build_open_flags` (`fs/open.c`).
/// # C: O(1)
