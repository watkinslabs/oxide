...
fn sys_wait4(args: &SyscallArgs) -> i64 { crate::wait::sys_wait4(args) }
...
/// # C: O(N_tasks)
fn sys_sched_rr_get_interval(args: &SyscallArgs) -> i64 {
...
pub unsafe extern "C" fn oxide_syscall_dispatch(
    ...
    let rv = match nr {
        ...
        syscall::nrs::NR_SETHOSTNAME   => crate::proc::sys_sethostname(&args),
        ...
        syscall::nrs::NR_GETCWD        => crate::fs::sys_getcwd(&args),
        syscall::nrs::NR_CHDIR         => crate::fs::sys_chdir(&args),
        ...
        syscall::nrs::NR_SET_TID_ADDRESS => crate::proc::sys_set_tid_address(&args),
        syscall::nrs::NR_WRITEV        => crate::fs::sys_writev(&args),
        syscall::nrs::NR_READV         => crate::fs::sys_readv(&args),
        ...
        syscall::nrs::NR_LSEEK         => crate::fs::sys_lseek(&args),
        syscall::nrs::NR_READLINK      => crate::fs::sys_readlink(&args),
        syscall::nrs::NR_READLINKAT    => crate::fs::sys_readlinkat(&args),
        syscall::nrs::NR_STATX         => crate::fs::sys_statx(&args),
        ...
        syscall::nrs::NR_TIMES         => crate::proc::sys_times(&args),
        syscall::nrs::NR_SYSINFO       => crate::proc::sys_sysinfo(&args),
        syscall::nrs::NR_MREMAP        => crate::proc::sys_mremap(&args),
        syscall::nrs::NR_MSYNC         => crate::proc::sys_msync(&args),
        syscall::nrs::NR_MINCORE       => crate::proc::sys_mincore(&args),
        syscall::nrs::NR_MLOCK | syscall::nrs::NR_MUNLOCK | syscall::nrs::NR_MLOCKALL | syscall::nrs::NR_MUNLOCKALL
                                 => crate::proc::sys_mlock_family(&args),
        syscall::nrs::NR_GETPGRP   => crate::proc::sys_getpgrp(&args),
        syscall::nrs::NR_GETPRIORITY => crate::proc::sys_getpriority(&args),
        syscall::nrs::NR_SETPRIORITY => crate::proc::sys_setpriority(&args),
        syscall::nrs::NR_ALARM     => crate::proc::sys_alarm(&args),
        syscall::nrs::NR_PAUSE     => crate::proc::sys_pause(&args),
        syscall::nrs::NR_GETITIMER => crate::proc::sys_getitimer(&args),
        syscall::nrs::NR_SETITIMER => crate::proc::sys_setitimer(&args),
        ...
        syscall::nrs::NR_GETPGID   => crate::proc::sys_getpgid(&args),
        syscall::nrs::NR_GETSID    => crate::proc::sys_getsid(&args),
        syscall::nrs::NR_SETPGID       => crate::proc::sys_setpgid(&args),
        syscall::nrs::NR_SETSID        => crate::proc::sys_setsid(&args),
        syscall::nrs::NR_UMASK         => crate::proc::sys_umask(&args),
        ...
        syscall::nrs::NR_GETDENTS | syscall::nrs::NR_GETDENTS64
                                 => crate::fs::sys_getdents64(&args),
        syscall::nrs::NR_PREAD64       => crate::fs::sys_pread64(&args),
        syscall::nrs::NR_PWRITE64      => crate::fs::sys_pwrite64(&args),
        syscall::nrs::NR_PREADV  => crate::fs::sys_preadv(&args),
        syscall::nrs::NR_PWRITEV => crate::fs::sys_pwritev(&args),
        syscall::nrs::NR_PREADV2 => crate::fs::sys_preadv(&args),
        syscall::nrs::NR_PWRITEV2 => crate::fs::sys_pwritev(&args),
        ...
        syscall::nrs::NR_VHANGUP       => crate::proc::sys_vhangup(&args),
        ...
        syscall::nrs::NR_SCHED_GETPARAM => crate::proc::sys_sched_getparam(&args),
        syscall::nrs::NR_SCHED_SETSCHEDULER | syscall::nrs::NR_SCHED_GETSCHEDULER
                                 => crate::proc::sys_sched_getscheduler(&args),
        syscall::nrs::NR_SCHED_GET_PRIORITY_MAX
                                 => crate::proc::sys_sched_get_priority_max(&args),
        syscall::nrs::NR_SCHED_GET_PRIORITY_MIN
                                 => crate::proc::sys_sched_get_priority_min(&args),
        ...
        syscall::nrs::NR_FUTEX         => crate::proc::sys_futex(&args),
        syscall::nrs::NR_FUTEX_WAITV   => crate::futex_waitv::sys_futex_waitv(&args),
        syscall::nrs::NR_CLONE3        => crate::proc::sys_clone3(&args),
        ...
        syscall::nrs::NR_DUP3          => crate::fs::sys_dup3(&args),
        ...
        syscall::nrs::NR_STAT          => crate::fs::sys_stat(&args, true),
        syscall::nrs::NR_LSTAT         => crate::fs::sys_stat(&args, false),
    ...
    if let Some(p) = crate::signal::take_lowest_pending() {
        ...
        let sig_rv = unsafe { crate::signal_dispatch::dispatch_pending(&p, rv as u64, &|sa| sys_exit(sa)) };
