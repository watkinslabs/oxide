...
pub(super) fn dispatch_route_a(nr: u64, args: &SyscallArgs) -> Option<i64> {
    Some(match nr {
        ...
        syscall::nrs::NR_MSGGET => ::ipc::sysv::msg::sys_msgget(args),
        syscall::nrs::NR_MSGSND => ::ipc::sysv::msg::sys_msgsnd(args),
        syscall::nrs::NR_MSGRCV => ::ipc::sysv::msg::sys_msgrcv(args),
        syscall::nrs::NR_MSGCTL => ::ipc::sysv::msg::sys_msgctl(args),
