...
pub(super) fn dispatch_route_b(nr: u64, args: &SyscallArgs) -> Option<i64> {
    Some(match nr {
        ...
        syscall::nrs::NR_MLOCK2 => crate::s149_mlock_family::sys_mlock2(args),
        syscall::nrs::NR_REMAP_FILE_PAGES => crate::s216_remap_file_pages::sys_remap_file_pages(args),
        syscall::nrs::NR_USTAT => crate::s136_ustat::sys_ustat(args),
        syscall::nrs::NR_SYSFS => crate::s139_sysfs::sys_sysfs(args),
        syscall::nrs::NR_FADVISE64 => crate::s221_fadvise64::sys_fadvise64(args),
        ...
        syscall::nrs::NR_TEE => crate::s275_splice::sys_tee(args),
        syscall::nrs::NR_VMSPLICE => crate::s275_splice::sys_vmsplice(args),
        ...
        syscall::nrs::NR_FSYNC => crate::misc::sys_fsync(args),
        syscall::nrs::NR_SYNC_FILE_RANGE => crate::misc::sys_sync_file_range(args),
        syscall::nrs::NR_READAHEAD => crate::misc::sys_readahead(args),
