//! Address-keyed waits and condition variables the runtime's own locks use.
//!
//! Semaphore objects belong to the semaphore owner; what stays here is the
//! futex-keyed address wait and the two condition-variable sleeps.
...
/// Dispatch the address-wait and condition-variable services.
/// # C: O(1) plus the wait
