...
pub fn map_nt_runtime(as_: &AddressSpace) -> Result<NtRuntime, pe::Error> {
    ...
    for index in 0..NTDLL_EXPORTS.len() {
        ...
        let selector = match index {
            ...
            533 => syscall::nt::NtService::RtlAcquireSRWLockExclusive,
            534 => syscall::nt::NtService::RtlAcquireSRWLockShared,
            535 => syscall::nt::NtService::RtlReleaseSRWLockExclusive,
            536 => syscall::nt::NtService::RtlReleaseSRWLockShared,
            537 => syscall::nt::NtService::RtlTryAcquireSRWLockExclusive,
            538 => syscall::nt::NtService::RtlWakeConditionVariable,
            539 => syscall::nt::NtService::RtlAddFunctionTable,
            540 => syscall::nt::NtService::RtlDeleteFunctionTable,
            541 => syscall::nt::NtService::RtlInstallFunctionTableCallback,
            542 => syscall::nt::NtService::RtlCompareString,
            543 => syscall::nt::NtService::RtlCopyUnicodeString,
            544 => syscall::nt::NtService::RtlEqualUnicodeString,
            545 => syscall::nt::NtService::RtlComputeCrc32,
            546 => syscall::nt::NtService::RtlImageRvaToSection,
