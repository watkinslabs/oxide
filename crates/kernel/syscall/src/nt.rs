...
pub enum NtService {
    ...
    RtlSizeHeap = 94,
    WineGetHostVersion = 199, RtlInterlockedFlushSList = 200, RtlInterlockedPushEntrySList = 201, RtlTryEnterCriticalSection = 202, RtlAreBitsClear = 203, RtlAreBitsSet = 204, RtlInitializeBitMap = 205, RtlLookupFunctionEntry = 206, RtlPcToFileHeader = 207, RtlSetBits = 208, RtlTimeToSecondsSince1970 = 209, RtlUnwindEx = 210, Setjmp = 211,
