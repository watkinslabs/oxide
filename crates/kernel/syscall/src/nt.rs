...
pub enum NtService {
    ...
    TpReleaseWork = 549,
    /// Release one process-owned native thread-pool timer object.
    TpReleaseTimer = 550,
    ...
    NtContinueEx = 598,
    /// Open a handle to the next thread of one process.
    NtGetNextThread = 599,
