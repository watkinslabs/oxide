...
pub fn decode_memory(call: NtCall) -> Result<NtMemoryCall, Errno> {
    ...
    match call.service {
        ...
        NtService::Wcstoul | NtService::WineDbgHeader | NtService::WineDbgOutput | NtService::WineDbgStrdup => Err(Errno::Enosys),
