...
pub fn decode_memory(call: NtCall) -> Result<NtMemoryCall, Errno> {
    ...
    match call.service {
        ...
        NtService::NtQueryValueKey | NtService::NtQueryVolumeInformationFile | NtService::NtQueueApcThread | NtService::NtQueueApcThreadEx2 | NtService::NtRaiseException => Err(Errno::Enosys),
