...
pub enum NtService {
    ...
    RtlSizeHeap = 94,
    WineGetHostVersion = 199, RtlInterlockedFlushSList = 200,
...
pub fn decode_memory(call: NtCall) -> Result<NtMemoryCall, Errno> {
    ...
    match call.service {
        ...
        NtService::Wcstoul | NtService::WineDbgHeader | NtService::WineDbgOutput | NtService::WineDbgStrdup | NtService::RtlGUIDFromString | NtService::RtlRandom | NtService::WineGetHostVersion | NtService::RtlInterlockedFlushSList => Err(Errno::Enosys),
