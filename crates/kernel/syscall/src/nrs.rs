...
// NOTE: x86_64 337..=423 are UNASSIGNED in mainline Linux (the gap between
// uprobe=336 and pidfd_send_signal=424).
...
pub const ARCH_GET_XCOMP_SUPP:       u64 = 0x1021;
pub const ARCH_GET_XCOMP_PERM:       u64 = 0x1022;
