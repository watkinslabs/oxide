...
const CAP_ENHANCED_IRTA_INVALIDATION: u64 = 1 << 62;
...
impl VtdRegisters {
    ...
    pub fn supports_enhanced_irta_invalidation(&self) -> bool { self.read64(CAP).is_some_and(|cap| cap & CAP_ENHANCED_IRTA_INVALIDATION != 0) }
