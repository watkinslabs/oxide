...
pub(crate) const NET_BONDING: u64 = 0xFEED_0016;
...
pub(crate) const CPU_SCALING_DIR: u64 = 0x3000_2000;
pub(crate) const CPU_SCALING_STATS_DIR: u64 = 0x3000_2100;
pub(crate) const CPU_SCALING_ATTR: u64 = 0x3000_2200;
pub(crate) const CPU_IDLE_DIR: u64 = 0x3000_2300;
pub(crate) const CPU_IDLE_STATE_DIR: u64 = 0x3000_2400;
pub(crate) const CPU_IDLE_ATTR: u64 = 0x3000_2600;
...
pub(crate) const LIVE_INO_TAG: u64 = 0x3000_0000_0000_0000;
