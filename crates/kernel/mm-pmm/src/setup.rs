...
use crate::{BITMAP_SLOTS, Error as PmmError, HIBERNATE_FORBIDDEN_SLOT,
            PAGEBLOCK_TYPE_SLOT, PageBacking, PcpStorage, Pmm, UsableRegion, PCP_BITMAP_SLOT};
...
pub(crate) use metadata::age_anon_for_hibernate;
