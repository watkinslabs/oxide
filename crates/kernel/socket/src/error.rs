...
impl From<vfs::VfsError> for Error {
    fn from(e: vfs::VfsError) -> Self {
        match e {
            ...
            vfs::VfsError::Econnaborted => Self::Econnaborted, vfs::VfsError::Econnreset => Self::Econnreset, vfs::VfsError::Enobufs => Self::Enobufs,
...
impl From<net::NetError> for Error {
    fn from(e: net::NetError) -> Self {
        match e {
            ...
            net::NetError::Eaddrinuse => Self::Eaddrinuse, net::NetError::Enodev => Self::Enodev,
            net::NetError::Enxio => Self::Enxio,
