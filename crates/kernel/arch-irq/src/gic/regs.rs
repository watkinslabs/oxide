...
/// Interrupt-group select, one bit per INTID. 1 = Non-secure Group 1 (IRQ),
/// 0 = Group 0 (FIQ when the distributor has a single security state).
#[cfg(target_arch = "aarch64")]
pub(super) const GICD_IGROUPR:    usize = 0x0080;
#[cfg(target_arch = "aarch64")]
