...
mod dmesg;
pub use dmesg::{
    install_ring_storage, kmsg_write, ring_oldest, ring_read, ring_size, ring_total,
    write_hex_u64, write_primary_dec_u64, write_primary_hex_u64, write_primary_raw,
    write_raw,
};
pub(crate) use dmesg::ring_push;
