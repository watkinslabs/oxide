...
pub use vbar::{install_default as install_default_vbar, current_svc_frame, set_current_svc_frame, SvcFrame, current_irq_frame, IrqFrameArm, OXIDE_IRQ_FRAME_ARM, VECTOR_ENTRY_BYTES, VECTOR_TABLE_SIZE};
