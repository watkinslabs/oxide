...
int main(void) {
    ...
    printf("complex_inverse_l=%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d/%d\n",
           creall(casinl(czero)) == 0.0L,
           cimagl(casinl(czero)) == 0.0L,
           creall(cacosl(cone)) > -0.000000000000001L && creall(cacosl(cone)) < 0.000000000000001L,
           cimagl(cacosl(cone)) == 0.0L,
           creall(catanl(czero)) == 0.0L,
           cimagl(catanl(czero)) == 0.0L,
           creall(casinhl(czero)) == 0.0L,
           cimagl(casinhl(czero)) == 0.0L,
           creall(cacoshl(cone)) == 0.0L,
           cimagl(cacoshl(cone)) == 0.0L,
           creall(catanhl(czero)) == 0.0L,
           cimagl(catanhl(czero)) == 0.0L);
