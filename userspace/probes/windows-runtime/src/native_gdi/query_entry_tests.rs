...
fn real_callback_entry_preserves_query_failure_dword_and_pthread_tls() {
    std::thread::spawn(|| {
        ...
        let req = abi::QueryRequest { version: 0, size: std::mem::size_of::<abi::QueryRequest>() as u32, dc: 1, kind: abi::QUERY_DATA,
            flags: 0, height: 16, width: 0, weight: 400, italic: 0, first: 0, count: 0,
            input: 0, output: 0, table: 0, offset: 0, capacity: 0, reserved: 0, aux: 0, value: 0, aux_bytes: 0, reserved2: 0 };
