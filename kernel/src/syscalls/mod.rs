...
pub unsafe extern "C" fn oxide_syscall_dispatch(
    ...
    let rv = match nr {
        ...
        syscall::nrs::NR_STATFS  => crate::syscalls::statfs::sys_statfs(&args),
        syscall::nrs::NR_FSTATFS => crate::syscalls::statfs::sys_fstatfs(&args),
