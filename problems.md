...
- RTM_GETROUTE does not emit RTA_MULTIPATH yet. RTM_NEWROUTE can import multipath nexthop arrays into duplicate equal-cost IPv4 route rows, but dumps still emit per-route rows.
